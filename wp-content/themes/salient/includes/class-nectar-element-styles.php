      ...
      foreach( $devices as $device => $media_query ) {
        ...
        if( true !== $fullscreen_rows_bypass ) {
          ...
          if( isset($atts['left_padding_'.$device]) && strlen($atts['left_padding_'.$device]) > 0 ) {
            ...
            self::$element_css[] = '@media only screen and (max-width: '.$media_query.') { #ajax-content-wrap '.$body_selector . $row_selector.'.left_padding_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['left_padding_'.$device]) ) . ' ' . $row_span12_selector .' {
          ...
          if( isset($atts['right_padding_'.$device]) && strlen($atts['right_padding_'.$device]) > 0 ) {
            ...
            self::$element_css[] = '@media only screen and (max-width: '.$media_query.') { #ajax-content-wrap '.$body_selector . $row_selector.'.right_padding_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['right_padding_'.$device]) ) . ' ' . $row_span12_selector .' {
